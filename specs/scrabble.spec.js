...
describe('Player', () => {
  ...
  describe('hasWon', () => {
    test('returns false when score < 100', () => {
      ...
      player.play('aaaaaaa');
      expect(player.totalScore()).toBe(57);
      expect(player.hasWon()).toBe(false);
    });
  ...
  describe('highestScoringWord', () => {
    ...
    test('returns the highest scoring word played', () => {
      ...
      player.play("bat");
      player.play('friend');
      expect(player.highestScoringWord()).toBe('friend');

      player.play("hat")
      player.play("AAAAAAA")
      expect(player.highestScoringWord()).toBe('AAAAAAA');
    });
  ...
  describe('highestWordScore', () => {
    test('returns the score of the highest scoring word played', () => {
      ...
      player.play("bat");
      player.play('friend');
      expect(player.highestWordScore()).toBe(10);
    });
