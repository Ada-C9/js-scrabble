...
describe('Player', () => {
  ...
  describe('hasWon', () => {
    test('returns false when score < 100', () => {
      ...
      expect(player.play('zzzz')).toBeTruthy();
      expect(player.plays.length).toBe(1);
    ...
    test('returns true when score == 100', () => {
      ...
      expect(player.play('kkkkzzz')).toBeTruthy();
      expect(player.plays.length).toBe(1);
      expect(player.hasWon()).toBeTruthy();
    ...
    test('returns true when score > 100', () => {
      ...
      expect(player.play('kkkzzzz')).toBeTruthy();
      expect(player.plays.length).toBe(1);
      expect(player.hasWon()).toBeTruthy();
  ...
  describe('highestScoringWord', () => {
    ...
    test('returns the highest scoring word played', () => {
      ...
      expect(player.play('pig')).toBeTruthy();

      // Test the functionality
      expect(player.highestScoringWord()).toBe('pig');
